                        ...
                        <div class="modal-dialog" id="popupFormModal" tabindex="-1" aria-labelledby="popupFormModalLabel" aria-hidden="true">
                            <div class="modal-content">
                                ...
                                <div class="modal-body mt-10">
                                    <form method="POST" action="{{('admin.company.store')}}">
                                        @csrf
                                        @method('post')
                                        ...
                                        <div class="flex flex-col space-y-2">
                                            ...
                                            <input id="address" type="text" name="address" value="{{ old('address') }}" placeholder="Enter address" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" />
