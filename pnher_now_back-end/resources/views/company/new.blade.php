<x-app-layout>
    <div>
        <main class="flex-1 mt-2 overflow-x-hidden overflow-y-auto bg-gray-200">
            <div class="container px-2 py-2 pb-16 flex justify-center rounded-xl">
                <div class="bg-white shadow-md rounded my-6 p-3 w-6/12">
                    <div class="modal-dialog" id="popupFormModal" tabindex="-1" aria-labelledby="popupFormModalLabel" aria-hidden="true">
                        <div class="flex justify-end">
                            <a href="{{route('admin.company.index')}}">
                                <span class="material-icons-outlined bg-red-300 p-2 rounded-full hover:text-red-500 mt-3">
                                    close
                                </span>
                            </a>
                        </div>
