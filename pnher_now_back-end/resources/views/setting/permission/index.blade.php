            ...
            <tbody>
              ...
              <tr class="hover:bg-grey-lighter">
                ...
                <td class="py-4 px-6 border-b border-grey-light text-right">
                  @can('Permission edit')
                  <a href="{{route('admin.permissions.edit',$permission->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-green-400">
                    <span class="material-icons-outlined">
                      border_color
                    </span>
                  </a>
