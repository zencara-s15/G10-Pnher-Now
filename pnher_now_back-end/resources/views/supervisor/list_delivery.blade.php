                ...
                <div class="flex">
                    <div class="flex-col w-full">
                        ...
                        <div class="container w-full flex flex-row mr-5 justify-between">
                            ...
                            {{-- <div class="row flex flex-row m-5 justify-between w-full bg-red-400"> --}}
                        ...
                        <div class="container-table mt-5 w-full ml-1 mr-8">
                            <div class="p-3">
                                <h1 class="text-2xl mr-30">List Delivery</h1>
                            </div>
                            <table class="mr-8 text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <th
                                            class="px-4 py-4 text-left text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                            User</th>
                                        <th
                                            class="px-4 py-4 text-left text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                            Type</th>
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($deliverieds as $deliveried)
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 whitespace-wrap text-sm">
                                                {{$deliveried->receiver_phone}}
                                            </td>
                                            <td class="px-4 py-4 whitespace-wrap text-sm font-medium text-gray-500">
                                                {{$deliveried->receiver_phone}}
                                            </td>
                                            <td class="px-4 py-4 whitespace-wrap text-sm text-gray-500">
                                                {{$deliveried->company}}
