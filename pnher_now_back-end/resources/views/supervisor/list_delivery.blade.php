                ...
                <div class="flex">
                    ...
                    <div class="container mb-7">
                        ...
                        <div class="container-table mt-5 w-full ml-1 mr-8">
                            <div class="p-3">
                                <h1 class="text-2xl ml-3">List Delivery</h1>
                            </div>
                            <table
                                class="text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ml-5">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @foreach ($deliverieds as $deliveried)
                                        <tr>
                                            <td class="px-7 py-4 whitespace-wrap text-sm font-medium text-gray-900">
                                                {{ $deliveried->post_id }}
                                            </td>
                                            <td class="px-7 py-4 whitespace-wrap text-sm text-gray-500">
                                                {{ $deliveried->type }}
                                            </td>
                                            <td class="px-7 py-4 whitespace-wrap text-sm text-gray-500">
                                            ...
                                            <td class="px-7 py-4 whitespace-wrap text-sm">
                                                {{ $deliveried->receiver_phone }}
                                            </td>
                                            <td class="px-7 py-4 whitespace-wrap text-sm font-medium text-gray-500">
                                                {{ $deliveried->receiver_phone }}
                                            </td>
                                            <td class="px-7 py-4 whitespace-wrap text-sm text-gray-500">
                                                {{ $deliveried->company }}
