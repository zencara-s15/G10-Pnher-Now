...
<template>
  <nav
    class="flex-no-wrap bg-gradient-to-l from-orange-400 to-red-500 relative flex w-full items-center justify-between shadow-lg lg:flex-wrap lg:justify-start lg:py-4"
  >
    <div class="flex w-full items-center justify-between px-4 py-1">
      ...
      <div class="flex-6 p-4 flex items-center justify-center w-50% h-60px">
        ...
        <div class="tab-container">
          ...
          <input type="radio" name="tab" id="tab3" class="tab tab--4" :checked="activeTab === 3" />
          <router-link class="tab_label" to="/user_feedback">Feedback</router-link>
