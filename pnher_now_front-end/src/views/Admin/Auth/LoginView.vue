<template>
  <div
    class="bg-gradient-to-l from-orange-400 to-red-500 container mx-auto flex justify-center items-center h-screen w-full"
  >
    <div
          ...
          <form @submit.prevent="onSubmit" class="w-full mt-8">
            ...
            <div class="mb-6 relative">
              ...
              <div class="relative">
                ...
                <span
                  class="absolute inset-y-0 right-0 pr-4 items-center mt-2"
            ...
            <div class="flex items-center justify-between mb-6">
              <a href="#" class="text-blue-600 hover:text-blue-800 italic underline"
                >Forgot Password?</a
              >
              <button
                class="bg-red-600 shadow appearance-none border rounded bg-red-500 text-white py-2 px-4 rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                type="submit"
            ...
            <div class="text-center">
              ...
              <a href="/register" class="text-blue-600 hover:text-blue-800 underline italic"
                >Signup</a
              >
            </div>
          </form>
