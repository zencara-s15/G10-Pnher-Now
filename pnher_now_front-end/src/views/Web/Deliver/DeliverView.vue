<template>
        ...
        <div class="card-body row" v-if="!hideCardBody">
          <div class="card-row">
            ...
            <div class="btn-group">
              ...
              <button type="button" class="btn btn-warning" @click="toggleCardBody">{{ hideCardBody ? 'Show' :
                'Hide' }} Card Body</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <div v-if="isAlertVisible" class="alert-card">
    <div class="alert-card-body">
      ...
      <button type="button" class="btn btn-outline-danger" @click="closeAlert">Close Alert</button>
    </div>
  </div>
</template>
